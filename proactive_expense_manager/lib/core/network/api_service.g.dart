...
class _ApiService implements ApiService {
  ...
  @override
  Future<SyncIdsResponseModel> addCategory(String id, String name) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'category_id': id, 'name': name};
    final _options = _setStreamType<SyncIdsResponseModel>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SyncIdsResponseModel _value;
    try {
      _value = SyncIdsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<DeleteIdsResponseModel> deleteCategory(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'category_id': id};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteIdsResponseModel _value;
    try {
      _value = DeleteIdsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SyncIdsResponseModel> addTransactions(
    AddTransactionsRequestModel request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
